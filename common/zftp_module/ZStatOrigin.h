...
// TODO this class copy-pasted from ZFSOrigin (yuck!) -- should find
// out how we can factor out the common behavior.

class ZStatOrigin : public ZOrigin {
public:
	ZStatOrigin(ZCache *zcache);
	...
	const char *get_origin_name() { return "ZStatOrigin"; }
