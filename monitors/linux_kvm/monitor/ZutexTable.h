...
{
public:
	ZutexTable(MallocFactory *mf, SyncFactory *sf, MemoryMapIfc *memory_map);


	void wait(ZutexWaitSpec *specs, uint32_t count, ZutexWaiter *waiter, VCPUYieldControlIfc *vyci);
